...
public class PlayerStatus : MonoBehaviour {
	...
	public SubAttribute statusAdd; //主属性（装备和技能)
	public SumAttribute statusCal; //总属性
	public SumEquip statusEquip;//
	public StatusGrowth statusGrowth,growthSetting; //升级后 属性成长量
	
	public float hpRegenTime; //生命回复
	public float mpRegenTime; //mp回复
	...
	void Start () {
		...
		Invoke("SettingStatus",0.1f);//0.1f之后调SettingStatus
        alreadyApply = true;
